...
class OnlineOffers extends Component<Props, State> {
  ...
  private async handleFocus() {
    console.log("focused on online offers");
...
export default connect<IStateProps, {}, OwnProps>(mapStateToProps, null)(OnlineOffers);